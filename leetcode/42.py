class Solution:
    ...
    def trap(self, height: List[int]) -> int:
        ...
        # We advance the left window as long as height of the left tower(the tallest height we've encountered in the left window so far) is <= the height of the right tower (the tallest height encountered so far in the right window).
        while left < right:
